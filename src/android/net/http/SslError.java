...
//  RMH note: This class is from the eclair (2.1) source. This class existed
//	all the way back in cupcake but was hidden until froyo (the code hasn't changed.)
//	It's included here because Foursquare uses a self-signed, wildcard certificate
//	(*.foursquare.com) while the OAuto api uses just foursquare.com. I included the source
//	here but removed the hidden attributes. Without these changes I would have to either:
//		1. Abandon support for 2.1 and support only 2.2 and 2.3. Since I don't have
//			a 2.2 device this option is a non-starter.
//		2. Use a call to the browser instead of a WebView. The user would still get warnings
//			about bad SSL certs when authenticating. That's not acceptable either.
//	
//	Similar changes were made to android.webkit.WebViewClient.java. 
